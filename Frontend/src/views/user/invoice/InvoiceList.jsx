...
//       <div className="flex justify-between items-center mb-8">
//         <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-200">Create Invoice</h2>
...
//             type="button"
//             onClick={() => logoInputRef.current.click()}
//             className="flex items-center px-4 py-2 bg-green-800 text-white rounded-md hover:bg-green-700 dark:bg-green-600 dark:hover:bg-green-500"
//           >
//             <UploadIcon className="h-5 w-5 mr-2" />
//             Upload Logo
//           </button>
...
//             value={customer.name}
//             onChange={(e) => setCustomer({...customer, name: e.target.value})}
//             className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-200 dark:bg-black-700 dark:text-white dark:border-gray-600 dark:focus:ring-green-500"
//             required
//           />
//         </div>
//       </div>
...
//         <div className="grid grid-cols-6 gap-4 mb-4 font-semibold text-gray-700 dark:text-gray-300">
//           <div className="col-span-3">Product</div>
//           <div>Quantity</div>
//           <div>Unit Price</div>
//           <div>Total Price</div>
...
//                 value={item.product}
//                 onChange={(e) => updateItem(index, 'product', e.target.value)}
//                 className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-700 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:focus:ring-green-500"
//                 required
//               >
//                 <option value="">Select Product</option>
//                 {products.map(product => (
...
//                 type="button"
//                 onClick={() => removeItem(index)}
//                 className="text-red-500 hover:bg-red-50 dark:hover:bg-red-700 p-2 rounded-full"
//               >
//                 <TrashIcon className="h-5 w-5" />
//               </button>
//             </div>
...
//           type="button"
//           onClick={addItem}
//           className="flex items-center text-green-800 hover:bg-green-100 dark:text-green-300 dark:hover:bg-green-700 px-4 py-2 rounded-md"
//         >
//           <PlusIcon className="h-5 w-5 mr-2" />
//           Add Item
//         </button>
...
//         <button 
//           type="submit"
//           className="px-8 py-3 bg-green-800 text-white rounded-md hover:bg-green-700 transition-colors dark:bg-green-600 dark:hover:bg-green-500"
//         >
//           Create Invoice
//         </button>
//       </div>
...
//   return (
//     <div className="container mx-auto px-4 sm:px-8 py-8 bg-gray-100 dark:bg-gray-900 min-h-screen">
//       <div className="flex justify-between items-center mb-8">
//         <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-200">Invoices</h1>
//         <div className="flex space-x-4">
//           <button 
//             onClick={() => setIsCreateModalOpen(true)}
//             className="flex items-center bg-green-800 text-white px-4 py-2 rounded-full hover:bg-green-700 dark:bg-green-600 dark:hover:bg-green-500 transition"
//           >
//             <PlusIcon className="h-5 w-5 mr-2" />
//             Create Invoice
//           </button>
...
//               value={filters.searchTerm}
//               onChange={(e) => setFilters(prev => ({...prev, searchTerm: e.target.value}))}
//               className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-green-700 dark:bg-gray-700 dark:text-white dark:focus:ring-green-500"
//             />
...
//             value={filters.status}
//             onChange={(e) => setFilters(prev => ({...prev, status: e.target.value}))}
//             className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-green-700 dark:bg-gray-700 dark:text-white dark:focus:ring-green-500"
//           >
//             <option value="">All Statuses</option>
//             <option value="PAID">Paid</option>
//             <option value="PENDING">Pending</option>
...
//               value={filters.startDate}
//               onChange={(e) => setFilters(prev => ({...prev, startDate: e.target.value}))}
//               className="w-[30%] px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-green-700 dark:bg-gray-700 dark:text-white dark:focus:ring-green-500"
//             />
//             <input 
//               type="date"
//               value={filters.endDate}
...
//             <button
//               onClick={applyFilters}
//               className="bg-green-800 text-white px-4 py-3 rounded-md hover:bg-green-700 dark:bg-green-600 dark:hover:bg-green-500 transition"
//             >
//               Apply Filters
//             </button>
//           </div>
...
//             <tr>
//               <th className="px-6 py-3 text-left text-xs text-green-900 dark:text-green-300 uppercase tracking-wider">Invoice #</th>
//               <th className="px-6 py-3 text-left text-xs text-green-900 dark:text-green-300 uppercase tracking-wider">Customer</th>
//               <th className="px-6 py-3 text-left text-xs text-green-900 dark:text-green-300 uppercase tracking-wider">Date</th>
//               <th className="px-6 py-3 text-left text-xs text-green-900 dark:text-green-300 uppercase tracking-wider">Total Amount</th>
//               <th className="px-6 py-3 text-left text-xs text-green-900 dark:text-green-300 uppercase tracking-wider">Status</th>
//               <th className="px-6 py-3 text-right text-xs text-green-900 dark:text-green-300 uppercase tracking-wider">Actions</th>
//             </tr>
//           </thead>
